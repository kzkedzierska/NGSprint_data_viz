...
```{r box_violin, exercise = TRUE, exercise.eval = TRUE, exercise.lines	= 29, fig.width = 15, fig.width = 4}
violin_box_plt <- 
  penguins_complete_df %>%
...
* [Website](https://twitter.com/kjhealy) of [Kieran Healy](https://twitter.com/kjhealy) - author of [Data Visualization: A Practical Introduction.](https://socviz.co/index.html)
...
2. Put together a visually appealing infographic describing the `ggplot2movies::movies` dataset. Select the key figures, decorate them with key annotations and showcase the most important things about the dataset. Write down the points you want to make and the stories you want to tell by those figures.
