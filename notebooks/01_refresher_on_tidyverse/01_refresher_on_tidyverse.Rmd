...
```{r thin_quiz}
quiz(
  question("Who has the lowest mass to height ratio?",
    answer("Wat Tambor"),
    answer("Yoda"),
    answer("Ratts Tyerell", correct = TRUE),
    answer("Jabba Desilijic Tiure", 
           message = "Hmm, Jabba has the biggest mass to height ratio. Did you forget to reverse the ordering in top_n? :)"), 
